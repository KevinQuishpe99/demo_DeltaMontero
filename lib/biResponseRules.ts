...
5. Comparativos (años, trimestres, productos): totales, variación % y **obligatorio** bloque chart JSON (\`{"type":"chart",...}\`) si piden gráfico o comparación entre períodos.
6. Tablas top-N: formato markdown tabla con números del tool; si piden gráfico además, incluye chart.
7. Nunca inventes cifras: solo valores del JSON rows del tool.
=== FIN REGLAS ===
`;
